package com.example.admin.wkend1;
...
public class activity_Channel extends AppCompatActivity  {
    ...
    String URL="https://www.googleapis.com/youtube/v3/search?part=snippet&channelId=UC9CYT9gSNLevX5ey2_6CK0Q&maxResults=25&key=AIzaSyCXCr1pvO03l-vDXa0e2X_nt9b75b8eBfM";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        customListAdapter = new CustomListAdapter(activity_Channel.this,videoDetailsArrayList);
        showVideo();
    }
