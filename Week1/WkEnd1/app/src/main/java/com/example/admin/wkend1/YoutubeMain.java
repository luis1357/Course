...
public class YoutubeMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customListAdapter=new CustomListAdapter(YoutubeMain.this,videoDetailsArrayList);
    ...
    private void showVideo() {
        ...
        String URL="https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&q="+searchName+"&key=AIzaSyCXCr1pvO03l-vDXa0e2X_nt9b75b8eBfM";
