package com.example.luisenriquez.week7day11.utils;
...
public class Utils
{
                                     ...
                                     String email, String id)
    {
        SharedPreferences sharedPreferences =
                context.getSharedPreferences(Constants.SHARED_PREFERENCES,
    ...
    public static String getLocalUsername(Context context)
    {
        ...
        return sharedPreferences.getString(Constants.PREFERENCES_USER_NAME,
    ...
    public static String getLocalUserId(Context context)
    {
        ...
        return sharedPreferences.getString(Constants.PREFERENCES_USER_ID,
